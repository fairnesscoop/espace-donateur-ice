      ...
      <?php if( get_theme_mod( 'ts_charity_date_hide',true) != '' || get_theme_mod( 'ts_charity_comment_hide',true) != '' || get_theme_mod( 'ts_charity_author_hide',true) != '' || get_theme_mod( 'ts_charity_time_hide',true) != '') { ?>
        <div class="metabox">
          <?php if( get_theme_mod( 'ts_charity_date_hide',true) != '') { ?>
            <span class="entry-date"><i class="<?php echo esc_attr(get_theme_mod('ts_charity_date_icon','fas fa-calendar-alt')); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span class="mx-2"><?php echo esc_html( get_theme_mod('ts_charity_metabox_separator_blog_post','|') ); ?></span>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_charity_comment_hide',true) != '') { ?>
            <span class="entry-comments"><i class="<?php echo esc_attr(get_theme_mod('ts_charity_comment_icon','fas fa-comments')); ?>"></i> <?php comments_number( __('0 Comment', 'ts-charity'), __('0 Comments', 'ts-charity'), __('% Comments', 'ts-charity') ); ?> </span><span class="mx-2"><?php echo esc_html( get_theme_mod('ts_charity_metabox_separator_blog_post','|') ); ?></span>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_charity_author_hide',true) != '') { ?>
            <span class="entry-author"><i class="<?php echo esc_attr(get_theme_mod('ts_charity_author_icon','fas fa-user')); ?>"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span class="mx-2"><?php echo esc_html( get_theme_mod('ts_charity_metabox_separator_blog_post','|') ); ?></span>
          <?php } ?>
          <?php if( get_theme_mod( 'ts_charity_time_hide',true) != '') { ?>
            <span class="entry-time"><i class="<?php echo esc_attr(get_theme_mod('ts_charity_time_icon','fas fa-clock')); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
          <?php }?>
        </div>
      <?php }?>
